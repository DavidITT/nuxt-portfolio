<template>
  <h4 class="font-bold uppercase text-xs md:text-sm lg:text-lg mt-10 text-gray-400 dark:text-stone-300 mb-10">
    {{ $t('skills.hosting') }}</h4>
  <div class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 mt-5 text-neutral-600 dark:text-slate-300">
    <div
      ...
      <svg clip-rule="evenodd" fill-rule="evenodd" height="32" stroke-linejoin="round" stroke-miterlimit="2"
           viewBox="7.002 8.287 148.203 175.426" width="32" xmlns="http://www.w3.org/2000/svg">
        <path d="m7.002 8.287 39.319 21.172v39.32h57.467l36.295 21.172h-133.081zm148.203 75.615v-54.443l-42.344-21.172v51.418zm0 99.811-39.319-21.172v-39.32h-57.467l-36.295-21.172h133.081zm-148.203-75.615v54.443l42.343 21.172v-51.418z"
              fill="currentColor"/>
      </svg>
      <h3 class="text-sm font-semibold">Hostinger</h3>
    </div>
    <div
        class="flex flex-col items-center justify-center space-y-2 hover:text-[#01B47C] cursor-pointer hover:translate-y-[-5px] transition-all duration-500">
      ...
      <h3 class="text-sm font-semibold">Netlify</h3>
    </div>
  </div>
</template>
